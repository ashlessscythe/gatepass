/*
  ...
  - The values [IN_YARD] on the enum `GatepassStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "GatepassStatus_new" AS ENUM ('PENDING', 'BOL_VERIFIED', 'CHECKED_IN', 'DOCUMENTS_TRANSFERRED', 'SEALED', 'LOADING', 'COMPLETED', 'CANCELLED');
...
-- AlterTable
ALTER TABLE "Gatepass" ADD COLUMN     "documentsTransferred" BOOLEAN NOT NULL DEFAULT false;
